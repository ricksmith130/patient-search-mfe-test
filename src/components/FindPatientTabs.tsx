...
import { FIND_PATIENT_ADVANCED_DETAILS, FIND_PATIENT_ADVANCED_DETAILS_LABEL, FIND_PATIENT_BASIC_DETAILS, FIND_PATIENT_BASIC_DETAILS_LABEL, FIND_PATIENT_NHS_NUMBER, FIND_PATIENT_NHS_NUMBER_LABEL, FIND_PATIENT_POSTCODE, FIND_PATIENT_POSTCODE_LABEL } from "../constants/FindPatientStrings";
